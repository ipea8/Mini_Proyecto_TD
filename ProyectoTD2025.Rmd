...
En este caso se repite el hecho de que la forma de pago puede encontrarse en diferentes líneas dentro del ticket, por eso vamos a aplicar la funciñon str_detect() para ver si es Tarjeta o Efectivo. Además queremos calcular también el importe total de cada método de pago. 
...
```
Tenemos ya el dataframe resumen_tickets que contiene solo las líneas de texto que hablan del método de pago. A partir de este dataframe calcularemos el importe total de cada método de pago. 
